...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY3Jpc3RpYW4tYmVybmFsLTk1IiwiYSI6ImNrOXI4NHYzNjBybnozbnFwZHp2ejM1eXcifQ.nhkgPev6DZro7krZdczBhA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/cristian-bernal-95/ck9rhk0wl15th1io9qvwffftn',
...
var stripe = Stripe('pk_test_qdfbLsQUsACd52Kv0qfYxGbr000AOxGYEl');
...
if (signUpForm) signUpForm.addEventListener('submit', function (e) {
  ...
  var user = (0, _login.signup)(name, email, password, passwordConfirm);
  console.log(user);
});
